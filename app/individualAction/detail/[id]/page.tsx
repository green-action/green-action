...
const DetailPage = () => {
  ...
  return (
    <div className="m-auto desktop:mt-[62px] laptop:mt-[113px] mb-[30px]">
      <div
        className="desktop:w-[1576.3px] mb-[25px] desktop:mx-[171px]
      laptop:w-[912px] laptop:mx-[55px]"
      >
        <Breadcrumbs>
      ...
      {/* 전체 contents */}
      <div
        className="flex flex-row desktop:w-[1576.3px] h-auto desktop:mx-[171px] mb-96 content-center
      laptop:w-[912px] laptop:mx-[55px]"
      >
        {/* 왼쪽 */}
        <div
